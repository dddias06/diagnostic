...
class Player(GameSprite):
 ...
 def fire(self):
     bullet = Bullet('111.png', self.rect.right, self.rect.centery, 15, 20, 15)
     bullets.add(bullet)
...
w2 = GameSprite('back.jpg', 370, 100, 50, 400)
...
#создаем спрайты
packman = Player('shark.png', 5, win_height - 80, 80, 80, 0, 0)
final_sprite = GameSprite('pacman1.png', win_width - 85, win_height - 100, 80, 80)
 
monster1 = Enemy('dog2.png', win_width - 80, 150, 80, 80, 5)
monster2 = Enemy('dog2.png', win_width - 80, 230, 80, 80, 5)
